...
const coreSanitizedSchema = {
  ...
  tagNames: [
    ...new Set([
      ...
      'agent-flow',
      'agent-table',
      // table caption (not in rehype-sanitize default schema)
      'caption',
      'agent-proceed',
  ...
  attributes: {
    ...
    'agent-proceed': ['className', 'label', 'allow-empty'],
    ...
    'agent-flow': ['className', 'kind', 'title', 'mode', 'view'],
    'agent-table': ['className', 'title', 'group-by', 'sort', 'density'],
